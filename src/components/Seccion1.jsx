...
const vapourRows = [
  {
    ...
    className:
      "absolute left-[4%] top-[8%] h-[13%] w-[92%] md:left-[5%] md:top-[10%] md:h-[16%] md:w-[44%]",
    fontSize: "82px",
  ...
  },
  {
    ...
    className:
      "absolute right-[3%] top-[24%] h-[14%] w-[94%] md:right-[4%] md:top-[12%] md:h-[18%] md:w-[54%]",
    fontSize: "66px",
  ...
  },
  {
    ...
    className:
      "absolute left-[3%] top-[41%] h-[16%] w-[94%] md:left-[8%] md:top-[38%] md:h-[20%] md:w-[84%]",
    fontSize: "78px",
    direction: "left-to-right",
    duration: 2.6,
    wait: 0.5,
  },
  {
    ...
    className:
      "absolute left-[4%] bottom-[21%] h-[13%] w-[92%] md:left-[5%] md:bottom-[14%] md:h-[18%] md:w-[72%]",
    fontSize: "58px",
    direction: "right-to-left",
    duration: 2.45,
    wait: 0.75,
  },
  {
    ...
    className:
      "absolute right-[5%] bottom-[7%] h-[13%] w-[86%] md:right-[7%] md:bottom-[9%] md:h-[16%] md:w-[38%]",
    fontSize: "74px",
    direction: "left-to-right",
    duration: 2.1,
    wait: 0.55,
